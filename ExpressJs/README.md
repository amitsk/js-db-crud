# Express.js + Handlebars CRUD App

A production-ready, DRY (Don't Repeat Yourself) multi-page CRUD web application built with Node.js, Express.js, Handlebars, and PostgreSQL.
