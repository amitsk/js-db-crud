...
export class ProductController {
  ...
  async getProduct(request: FastifyRequest<{ Params: ProductIdParam }>, reply: FastifyReply) {
  ...
  async deleteProduct(request: FastifyRequest<{ Params: ProductIdParam }>, reply: FastifyReply) {
    const { id } = request.params;
