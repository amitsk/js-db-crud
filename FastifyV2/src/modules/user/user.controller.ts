...
import { CreateUserInput, UpdateUserInput, UserIdParam, ListUsersQuery } from "./user.schema";
...
export class UserController {
  ...
  async getUser(request: FastifyRequest<{ Params: UserIdParam }>, reply: FastifyReply) {
  ...
  async deleteUser(request: FastifyRequest<{ Params: UserIdParam }>, reply: FastifyReply) {
    const { id } = request.params;
