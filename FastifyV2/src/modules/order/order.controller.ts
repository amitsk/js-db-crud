...
import { CreateOrderInput, UpdateOrderInput, OrderIdParam, ListOrdersQuery } from "./order.schema";
...
export class OrderController {
  ...
  async listOrders(request: FastifyRequest<{ Querystring: ListOrdersQuery }>, reply: FastifyReply) {
  ...
  async getOrder(request: FastifyRequest<{ Params: OrderIdParam }>, reply: FastifyReply) {
  ...
  async deleteOrder(request: FastifyRequest<{ Params: OrderIdParam }>, reply: FastifyReply) {
    const { id } = request.params;
